...
export const addMember = (req, res, next) => {
    ...
    db_connection.query(getNationalId, (err, result)=>{
        ...
        if(result.length){
            ...
            return res.json({message: "this member is already exist"})
        }
        ...
        db_connection.query(insetQuery, (err, result)=>{
            ...
            return res.json({message: `Member added successfully with id ${result.insertId}`})
        })
    })
...
export const getMembersWithTrainer = (req, res, next)=>{
    ...
    db_connection.execute(selectQuery, (err, result)=>{
        ...
        return res.json({message: "All members and member's trainer data fetched successfully", data: result})
    })
}
...
export const membersRevenues = (req, res, next)=>{
    ...
    db_connection.execute(selectQuery, (err, result)=>{
        ...
        return res.json({message: "All members' revenues fetched successfully", data: result})
    })
}
...
export const updateMember = (req, res, next)=>{
    ...
    db_connection.execute(updateQuery, (err, result)=>{
        ...
        return res.json({message: "Members Data Updated", data: result})
    })
}
...
export const softDeleteMember = (req, res, next)=>{
    ...
    db_connection.execute(softDeleteQuery, (err, result)=>{
        ...
        return res.json({message: `member with id ${id} deleted successfully`})
    })
}