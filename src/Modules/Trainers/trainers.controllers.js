...
export const addTrainer = (req, res, next)=>{
    ...
    db_connection.query(insetQuery, (err, result)=>{
        if(err){
            ...
            return res.json({massge: 'Query Error', error: err.message})
        }
        
        if(!result.affectedRows){
            // Return a message if the trainer was not added
            return res.json({message: 'Trainer Not added'})
        }
...
export const getTrainerWithMembers = (req, res, next)=>{
    ...
    db_connection.execute(selectQuery, (err, result)=>{
        ...
        return res.json({message: "All trainer and trainer's members data fetched successfully", data: result})
    })
}
...
export const getTrainerById = (req, res, next)=> {
    ...
    db_connection.execute(selectQuery, (err, result)=>{
        ...
        if(!result.length){
            ...
            return res.json({message: 'This trainer Not Found!'})
        }
        // Return a success message with the fetched data
        return res.json({message: "get trainer by Id and trainer's members data fetched successfully", data: result})
    })
}
...
export const trainerRevenues = (req, res, next)=>{
    ...
    db_connection.execute(selectQuery, (err, result)=>{
        ...
        return res.json({message: "Trainer Revenues", data: result})
    })
}
...
export const updateTrainer = (req, res, next)=>{
    ...
    db_connection.execute(updateQuery, (err, result)=>{
        ...
        return res.json({message: "TrainerData Data Updated", data: result})
    })
}
...
export const deleteTrainer = (req, res, next)=>{
    ...
    db_connection.execute(deleteQuery, (err, result)=>{
        ...
        return res.json({message: `Trainer With Id ${id} deleted successfully`})
    })
}